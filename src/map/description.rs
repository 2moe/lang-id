use crate::map::PhfMap;
use phf::phf_map;

/// This function returns a `PhfMap` containing language codes as keys and their corresponding descriptions as values.
///
/// This `PhfMap` is built using the `phf_map!` macro.
///
/// # Examples
///
/// ```
/// use lang_id::map::description::desc_map;
///
/// let map = desc_map();
/// assert_eq!(map["en-001"], "English, Latin, world");
/// ```
pub const fn desc_map() -> PhfMap<'static> {
    phf_map! {
    ...
    "sw-CD" => "Kiswahili, Kilatini, Jamhuri ya Kidemokrasia ya Kongo",
